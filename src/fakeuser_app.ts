...
import {FakeUser} from "./model/fakeUser";
...
app.get('/fake', (req, res) => {
    pool.query('select * from fake_user.fake_user.fake_user order by uid', (error:any, response:any) => {
